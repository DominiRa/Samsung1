...
# 1.1_check dimensions of training data (dim())

data_subject_train<-read.csv("./UCI HAR Dataset/train/subject_train.txt",header = FALSE)
data_x_train<-read.csv("./UCI HAR Dataset/train/X_train.txt",header = FALSE)
data_y_train<-read.csv("./UCI HAR Dataset/train/y_train.txt",header = FALSE)

body_acc_x_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_acc_x_train.txt",header = FALSE)
body_acc_y_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_acc_y_train.txt",header = FALSE)
body_acc_z_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_acc_z_train.txt",header = FALSE)
body_gyro_x_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_gyro_x_train.txt",header = FALSE)
body_gyro_y_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_gyro_y_train.txt",header = FALSE)
body_gyro_z_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/body_gyro_z_train.txt",header = FALSE)
total_acc_x_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/total_acc_x_train.txt",header = FALSE)
total_acc_y_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/total_acc_y_train.txt",header = FALSE)
total_acc_z_train<-read.csv("./UCI HAR Dataset/train/Inertial Signals/total_acc_z_train.txt",header = FALSE)

# 1.2_check dimensions of test data (dim())

data_subject_test<-read.csv("./UCI HAR Dataset/test/subject_test.txt",header = FALSE)
data_x_test<-read.csv("./UCI HAR Dataset/test/X_test.txt",header = FALSE)
data_y_test<-read.csv("./UCI HAR Dataset/test/y_test.txt",header = FALSE)

body_acc_x_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_acc_x_test.txt",header = FALSE)
body_acc_y_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_acc_y_test.txt",header = FALSE)
body_acc_z_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_acc_z_test.txt",header = FALSE)
body_gyro_x_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_gyro_x_test.txt",header = FALSE)
body_gyro_y_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_gyro_y_test.txt",header = FALSE)
body_gyro_z_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/body_gyro_z_test.txt",header = FALSE)
total_acc_x_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/total_acc_x_test.txt",header = FALSE)
total_acc_y_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/total_acc_y_test.txt",header = FALSE)
total_acc_z_test<-read.csv("./UCI HAR Dataset/test/Inertial Signals/total_acc_z_test.txt",header = FALSE)

# 1.3_put data training together

all_train_data<-cbind(data_subject_train,data_x_train,data_y_train,body_acc_x_train,body_acc_y_train,body_acc_z_train,body_gyro_x_train,body_gyro_y_train,body_gyro_z_train,total_acc_x_train,total_acc_y_train,total_acc_z_train)

#splitNames=strsplit(names(all_train_data),"\\.")
#firstElement<-function(x){x[1]}
#sapply(splitNames,firstElement)

#1.4_put data test together
...
#dim(all_data)
#[1] 10299    12
# write.table(all_data)-nie robic chyba bo strasznie długo trwa i wyrzuca na console b duzo danych

#1.5 put diffrent working name for each column
names(all_data)<-c("V1","V2","V3","V4","V5","V6","V7","V8","V9","V10","V11","V12")
...
#5.5 put diffrent working name for each column
